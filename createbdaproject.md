...
For this solution, we will be processing a PDF file which has 2 documents - 1) Tax Form 2) Driver License using Bedrock Data Automation (BDA). We will use BDA to identify each document, and then to extract the data we need for downstream processing
...
<img src="../../assets/screenshots/AWS_Console_Screenshot_2_-_idpdemo_project.png" width="800" />
...
* Select the sample named “tax_certificate.pdf” for upload. Click the "Upload File" button.
* For an initial prompt, enter “This is an tax_certificate form. Please extract all the keys and values from the form.”
...
* Name the blueprint “conveyance-tax-certificate”
